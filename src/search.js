    ...
    return (
      <div>
        <nav className="searchnav">
          <Link to="/">
            <FontAwesomeIcon icon="chevron-left" onClick={clear} />
          </Link>
          <img
            className="logo logo__searchnav"
            src={'https://vectr.com/koko57/bK5KH3g7S.svg?width=539&height=179.66&select=bK5KH3g7Spage0'}
            alt="MyReads"
          />
          <div className="logo" />
